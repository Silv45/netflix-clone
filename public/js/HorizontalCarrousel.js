function carrousel(carrouselName) {
    ...
    let cardWidth = parseFloat(window.getComputedStyle(Array.from(document.getElementsByClassName("carrousel-card-h"))[0]).getPropertyValue("width").replace("px", ""));
    ...
    let cardCount = Array.from(document.getElementsByClassName("carrousel-card-h")).length;
